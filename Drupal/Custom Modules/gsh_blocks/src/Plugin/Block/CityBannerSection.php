 ...
 *
 * @Block(
 *  id = "city_banner_block",
 *  admin_label = @Translation("City banner block"),
 * )
 */
class CityBannerSection extends BlockBase implements BlockPluginInterface {
